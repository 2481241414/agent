...
def main():
    # --- 文件路径配置 ---
    # 你的原始数据文件
    original_data_path = r'D:\Agent\data\单gt.csv' 
    # 你的映射表文件
    mapping_table_path = r'D:\Agent\data\大类-工具映射关系表-0707-Cleaned.csv' 
    # 清洗后要保存的新数据文件
    corrected_data_path = r'D:\Agent\data\corrected_data.csv'
